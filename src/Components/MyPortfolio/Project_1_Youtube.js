          ...
          >
            ...
            >
              <div className="flex items-center space-x-2">
                <h1 className="text-3xl pb-1">1)</h1>
                <h1 className="text-2xl">
                  {"     Youtube Clone Using OpenSource API"}
                </h1>
              </div>
              <p className="text-gray-500">
                I undertook the challenge of recreating the YouTube website as a
                personal project to enhance my skills in web development.
                Leveraging an available open-source API(Rapid API), I
                meticulously crafted a clone of the YouTube, focusing on the
